...
public final class ScreenUtils {
    ...
    /**
     * 部分手机有虚拟键盘，那么就要区别一个手机高度 与 APP占据的屏幕高度
     * @param context
     * @return
     */
    ...
    public static int[] getPhoneHeight2(Activity activity) {
    ...
    public static int getBottomKeyboardHeight(Activity activity){
        int screenHeight =  getPhoneHeight2(activity)[1];
        DisplayMetrics dm = new DisplayMetrics();
        activity.getWindowManager().getDefaultDisplay().getMetrics(dm);
        int diffHeight = screenHeight - dm.heightPixels;
        return diffHeight;
    }
     ...
     * 获取屏幕密度
     */
    public static float getScreenDensity(@NonNull Context appContext) {
     ...
     * 获取屏幕密度 DPI
     */
    public static int getScreenDensityDpi(@NonNull Context appContext) {
     ...
     * 判断是否横屏
     */
    public static boolean isLandscape(@NonNull Context appContext) {
     ...
     * 判断是否竖屏
     */
    public static boolean isPortrait(@NonNull Context appContext) {
     ...
     * 判断是否锁屏
     */
    public static boolean isScreenLock(@NonNull Context appContext) {
     ...
     * @param duration 时长
     */
    public static void setSleepDuration(@NonNull Context appContext, int duration) {
        Settings.System.putInt(appContext.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT, duration);
    }
     ...
     */
    public static int getSleepDuration(@NonNull Context appContext) {
        try {
            return Settings.System.getInt(appContext.getContentResolver(), Settings.System.SCREEN_OFF_TIMEOUT);
     ...
     * 判断是否是平板
     */
    public static boolean isTablet(@NonNull Context appContext) {
        return (appContext.getResources().getConfiguration().screenLayout
